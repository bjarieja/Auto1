...
\begin{itemize}
	\item 
	Der Einfluss von Alkohol, Medikamenten oder Drogen kann zu diversen Gefahren bei der Verwendung des Produkts führen. Weierhin darf das Tischförderband nur im nüchternen udn gesunden Zustand bedient werden.
	\item 
	Falls das Produkt sichtbare Schäden aufweist, so verwenden Sie es nicht mehr. Abhängig vom Produkt und von der Beschädigung besteht nicht nur Verletzungsgefahr (z.B. durch scharfe Kanten), sondern auch Lebensgefahr (z.B. durch einen elektrischen Spannungsübertritt).

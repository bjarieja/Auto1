...
\resizebox{0.7\textwidth}{!}{%
	\begin{tikzpicture}[line width=0.8pt]
		...
		\node[rotate=90, fill=white] at (26.875,-1.875) {\textbf{Reset-Knopf}};
		\node[rotate=90, fill=white] at (27.375,-0.375) {Quittierung von Fehlermeldungen};
		
		\draw[dashed] (24.875,5.375) -- (26.75,5.375);
		\node[rotate=90, fill=white] at (27.125,6) {\textbf{Ein- / Ausschalter}};
		\node[rotate=90, fill=white] at (27.625,6.875) {Einschalten des Tischförderbands};
		
		\draw[dashed] (20.875,5.5) -- (16,0.375);
		\node[rotate=90, fill=white] at (16.125,2.125) {\textbf{Modusschalter}};
		\node[rotate=90, fill=white] at (17.25,5.25) {Modus wählen (Linkslauf / Automatiklauf / Rechtslauf)};
		\node[rotate=90, fill=white] at (16.75,3.375) {Laufrichtung des Transportbandes};
		
		\draw[dashed] (28.75,18.5) -- (30,18.5);
		\draw[dashed] (30,18.5) -- (30,-11.5);
		\draw[dashed] (30,-11.5) -- (28.75,-11.5);
		\draw[dashed] (30,-7.75) -- (31.25,-7.75);
		\node[rotate=90, fill=white] at (31.25,-5.25) {\textbf{Klappbare Stützfüße}};
		\node[rotate=90, fill=white] at (31.875,-3.625) {Für Transport einklappen};
		...
		\node[rotate=90, fill=white] at (11.75,-5.75) {Transportboxen korrekt platzieren};
		
		\draw[dashed] (20.75,-1.5) -- (16.25,-6.5);
		\node[rotate=90, fill=white] at (16.5,-5.125) {\textbf{Bildschirm}};
		\node[rotate=90, fill=white] at (17,-3.625) {Anzeige von Fehlermeldungen};
		
		\draw[dashed] (21.125,10.875) -- (16.25,11.75);
		\node[rotate=90, fill=white] at (16.125,15) {\textbf{Geschwindigkeitseinstellung}};

...
\part{Anwendungsbeschreibung}  

\input{../../Contents/General/RenameAppXY}

\part{Hadwarebeschreibung}  

 \input{../../Contents/General/de/ArduinoR4}
 \input{../../Contents/General/de/MotorTreiberBTS7960}
 \input{../../Contents/General/de/MotorSR555SHP}

 % \input{../../Contents/General/RenameHardwareXY}
   \input{../../Contents/General/de/Schalter}
   \input{../../Contents/General/de/Potentiometer}
  \input{../../Contents/General/de/Display}
  
   \input{../../Contents/General/de/LichtschrankeE118}
%  \input{../../Contents/General/de/GabellichtschrankeF249}
 % \input{../../Contents/General/RenameActorXY}
%   \input{../../Contents/General/de/NFCSchraube}
   \input{../../Contents/General/de/NFCPlate}

\part{Arduino IDE}  

\input{../../Contents/General/de/ArduinoIDE2Win}
\input{../../Contents/General/de/ArduinoIDE2Mac}
\input{../../Contents/General/de/ArduinoIDE2}

  %\input{../../Contents/General/RenamePythonToolXY}

  %\input{../../Contents/General/RenameHardwareToolXY}
\part{Regelung}
\input{../../Contents/General/de/PIRegelung}
\part{Entwicklung}

  \input{../../Contents/General/de/EntwicklungDerProgrammlogik}
...
\part{\TRANS{Anhang}{Appendix}}
  ...
  \cleardoublepage
  \input{../../Contents/General/de/BillofMaterial}

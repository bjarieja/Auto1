...
Nachfolgende Tabelle (\ref{JoyIt}) zeigt die im Datenblatt \cite{Simac:2020} %entnommen technischen Eigenschaften des SERIELLES I2C 20X4 LCD MODUL.

\begin{table}[h!]
	\caption{Technische Spezifikationen des Displays gemäß Herstellerdokumentation \cite{Simac:2020}.} 
	\begin{center}
		\begin{tabular}{|l|l|}
			\hline
			...
			Adapterchip &  PCF8574	\\	
			\hline
			Besonderheiten  & Aufgelöteter I2C Kommunikations-Adapter: nur 4 I/O \\ Leitungen für Betrieb not-wendig(Spannungsversorgung + 2 Datenleitungen) 	\\	
			\hline
...
Dieses Display \cite{Simac:2020} hat die folgenden geometrischen Kenndaten:
\begin{itemize}{
...
%Gleiches Display selbe specs, auf der Website, aber in dem Dokument Grünes Hintergrundlicht

\begin{center}
	\includegraphics[width=\textwidth]{../../Images/Display/Maße2004.png}
	\captionof{figure}{Maße des 2004 Display\cite{Simac:2020}}
	\label{pic:2004D}
\end{center}
...
\begin{itemize}{
		...
		Um diese Bibliothek zu verwenden, geben Sie Folgendes an \#include <liquidcrystal.h>. %(https://www.renesas.com/en/products/gadget-renesas/reference/gr-rose/library-liquid?srsltid=AfmBOoq04teay6jaOZtCl3BjtGM_L6hWni4345fnIm2JRUE_HfkQ9-E9)

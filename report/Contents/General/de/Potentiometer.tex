...
\begin{center}
	\begin{enumerate}
		...
		\item Den Arduino mit einem Computer verbinden.
		\item Spannungsversorgung (12V) einschalten.   
		\item Die Welle des Drehpotentiometers langsam von einem Anschlag zum anderen drehen.
		\item Auf dem Seriellen Monitor die Veränderung der Werte beobachten (s. \ref{sec:codePoti})Prüfen ob der Motor sich mit konstanter Drehzahl dreht. 
	\end{enumerate}  
\end{center}

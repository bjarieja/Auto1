...
\section{Beschreibung Supraplate}
...
\begin{table}[h!]
	\caption{Nachfolgende Tabelle (\ref{SupraPlate}) zeigt die im Datenblatt \cite{} entnommen technischen Eigenschaften der Supra Plate.}
	\begin{center}
		\begin{tabular}{|l|l|}
			\hline

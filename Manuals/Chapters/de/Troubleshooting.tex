...
\begin{itemize}
	...
	\textbf{Mögliche Ursachen:} Die Stützbeine sind blockiert. \\
	\textbf{Behebung:} Stützbeine auf Fremdkörper prüfen und diese entfernen. Die Vorspannung der Stützbeine durch leichtes Drehen der Schrauben am Drehpunkt verringern.
	
	\item \textbf{Das Transportband lässt sich nicht bewegen} \\
	\textbf{Mögliche Ursachen:} Fremdkörper blockieren das Transportband. \\
	\textbf{Behebung:} Tischförderband vom Strom trennen. Das Transportband auf eingeklemmte Fremdkörper überprüfen und diese entfernen. 
	
	\item \textbf{Das Tischförderband wackelt} \\ 
	\textbf{Mögliche Ursachen:} Das Tischförderband steht auf einem unebenen Untergrund, ein Stützbein ist beschädigt oder nicht vollständig ausgeklappt. \\ 
	\textbf{Behebung:} Die Stützbeine auf Beschädigungen überprüfen und erneut ein- und ausklappen. Bei keiner Beschädigung das Tischförderband an einem anderen Ort positionieren. Wenn der Fehler weiterhin besteht, Stützbeine austauschen lassen.
	
	\item \textbf{Das Transportband des Tischförderbands bewegt sich nicht} \\ 
	\textbf{Mögliche Ursachen:} Das Transportband ist nicht gespannt. \\ 
	\textbf{Behebung:} Das Transportband mittels Einstellschrauben spannen (siehe.~\ref{sec:einstellen}). 
	
\end{itemize}

\section{Elektrische Fehler}
...
\begin{itemize}
	...
	\textbf{Mögliche Ursachen:} Keine Spannungsversorgung, fehlerhafte Verkabelung, defekter Motor. \\
	\textbf{Behebung:} Spannungsversorgung prüfen und die korrekte Position des Hauptschalters kontrollieren.
	
	\item \textbf{Das Transportband läuft unregelmäßig} \\
	\textbf{Mögliche Ursachen:} Instabile Spannungsversorgung, fehlerhaftes PWM-Signal, mechanische Blockade. \\
	\textbf{Behebung:} Auf Verunreinigungen prüfen, Hersteller kontaktieren. 
	...
	\textbf{Behebung:} Das Tischförderband aus- und wieder einschalten. Das System mittels Reset-Taster zurücksetzen. Gegebenenfalls den Sensor austauschen lassen. 
	...
	\textbf{Behebung:} Dauerlaufzeit reduzieren, Pausen einplanen und die Umgebungstemperatur, sofern möglich, senken. 
	
	\item \textbf{Tischförderband stoppt unerwartet} \\

...
\begin{itemize}
	...
	\textbf{Mögliche Ursachen:} Die Stützbeine sind blockiert oder fehlen. \\
	\textbf{Behebung:} Stützbeine auf Fremdkörper prüfen und diese entfernen. Die Vorspannung der Stützbeine durch leichtes Lösen der Schraube verringern.
	
	\item \textbf{Das Transportband lässt sich nicht bewegen} \\
	\textbf{Mögliche Ursachen:} Fremdkörper blockieren das Transportband. \\
	\textbf{Behebung:} Das Tischförderband auf eingeklemmte Fremdkörper überprüfen und diese entfernen. 
	
	\item \textbf{Das Tischförderband steht schief} \\ 
	\textbf{Mögliche Ursache:} Die Stützbeine des Tischförderbands sind nicht vollständig ausgeklappt und arretiert. \\
	...
	\textbf{Behebung:} Die Stützbeine auf Beschädigungen überprüfen und ggf. austauschen. Bei keiner Beschädigung das Tischförderband an einem anderen Ort positionieren. 
	
	\item \textbf{Der Transportband des Tischförderbands bewegt sich nicht} \\ 
	\textbf{Mögliche Ursachen:} Das Transportband ist nicht gespannt. \\ 
	\textbf{Behebung:} Das Transportband mittels Einstellschrauben spannen. 

...
und der Einhaltung von Stromgrenzen. 
	...
	\textbf{Limitation:} Der Artikel erwähnt zwar herrkömmliche Methoden zu Drehzahlregulierung, führt jedoch keinen qunatitativen Vergleich durch. Somit werden Potenzial aufgezeigt, jedoch nicht messbar begründet. Auch werden Rechenaufwand für MPC und nichtideale Motoreffekte nicht näher beleuchtet. 
...
{ 
	...
	Dieser Artikel \cite{Wescott:2018}	erläutert die grundlegende Funktionsweise der PID Regelugn anschaulich anhand eines Elektromotors. Zudem zeigt er Unterschiede einzelner aus der PID abgeleiteter Methoden qunatifiziert auf. 
	\bigskip
	
	\textbf{Limitation:} Dieser Artikel stamm einzig von einem Berater für Regelungstechnik udn eignet sich somit nur bedingt als Grundlage für einen Bericht. 
	
	\scriptsize{\textbf{Keywords:} PID, PID controll, BLDC, control systems, proportional integral controll. }
}
...
{ 
	...
	\textbf{Limitation:} Dies ist eine von der TUM veröffentlichte Studentische Arbeit. Ihre Zuverlässigkeit ist als gering zu betrachten, da lediglich wenige Personen diese Veröffentlichugn gelesen bzw. korrigiert haben. 

...
\STANDARD{Motoren}
{ 
\textbf{Grundsätzlich:} Durch \textbf{Rotation eines Magnetfeldes)} wird ein \textbf{Anzugsmoment} auf den rotierenden Körper (\textbf{\glqq Rotor"}) erzeugt. Hierbei \textbf{muss} das \textbf{äußere Magnetfeld schneller} rotieren als der \textbf{Rotor} selbst. \cite{Feynman:2020}
}

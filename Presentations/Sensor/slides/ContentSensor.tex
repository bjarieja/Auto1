...
\STANDARD{Motortreiber und H Brücke} 
{
	...
	Alternativ zur Transistor Halbbrücke, welche klassische stromgesteuerte Transistoren verwendet, können auch \textbf{MOSFETS} (Metal-Oxide-Semiconductor Field-Effect Transistor) in Halbbrücken verwendet werden. Diese schalten \textbf{spannungsgesteuert} und sind weitaus \textbf{effizienter} \cite{Wallaschek:2025}. 
}
...
\STANDARD{Möglichkeiten des Betriebes}
{ 
\textbf{Grundlegend:} Ein Motortreiber kann als binärer Verstärker verwendet werden. In diesem Fall werden festgelegte Drehzahlen gefahren. 
 ...
 \begin{itemize}
 	\item Sensor nimmt IST-Wert auf.

...
\begin{itemize}
	...
	\item \textbf{Einweg-Lichtschranken:} Transmitter und Receiver gegenüberliegend. Hohe Auflösung, bis zu 10m \cite{Hering:2023}
	\item \textbf{Reflex-Lichtschranken:} Transmitter und Receiver in einem Gehäuse, \textbf{Reflektor}. Einfache Einstellung, bis zu 5m Abstand \cite{Hering:2023}
\end{itemize}
}
\STANDARD{Optische Näherungssenoren}
{ 
